  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      {/* <header className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-gray-800">My Company</h1>
        <nav>
      ...
      <main className="max-w-md mx-auto space-y-8">
        <h2 className="text-2xl font-bold text-gray-800">{t("bout")}</h2>
        <p className="text-gray-600">{t("Aboutd")}</p>
        <img
          ...
          alt="Company Image"
          className="w-full rounded-lg shadow mx-auto"
        />
      </main>
    </div>
  );
